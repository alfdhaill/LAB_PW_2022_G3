    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-body">
            <form action="<?php echo e(URL::to('save')); ?>" id="addForm">
                <div class="mb-3">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-body">
            <form action="<?php echo e(URL::to('update')); ?>" id="editForm">
...
</div><?php /**PATH C:\xampp\htdocs\project-armory2\resources\views/modal.blade.php ENDPATH**/ ?>